...
const beckhoffIP = "192.168.1.25";
const localIP = ip.address();

const influxIP = "192.168.1.55";
const influxPort = 8086;
const influxUser = "nodejs";
const influxPass = "nodejs";

const openhabIP = "192.168.1.60";
...
// write to the influx database via http call
...
// push back a Openhab update via the REST API
...
// read all values for a category of OpenHAB items from the Beckhoff PLC
...
// check a specific OpenHAB category for updated values
...
// calculate the next time for timer execution
...
// process all openhab related jobs
...
// push back a new value to the Beckhoff PLC
...
// push back a series of values to the Beckhoff PLC
...
// get values from the Influx database via a http query
...
// push openhab switch value to the PLC
...
// push openhab dimmer to the PLC
...
// push openhab required screen position to the PLC
...
// fetch all stored values in the LokiJS database to update the OpenHAB GUI
